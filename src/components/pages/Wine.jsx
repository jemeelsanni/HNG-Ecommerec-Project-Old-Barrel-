    ...
    const fetchProducts = async () => {
      try {
        const response = await axios.get(
          "/api/products?organization_id=412f7382572440f0a6a1191e3d65a77c&reverse_sort=false&page=1&size=20&Appid=1VPSVW4FENHI09L&Apikey=ab2f5ea9b8f841b695f321ca12c160a720240713012101546394",
          {
            headers: {
